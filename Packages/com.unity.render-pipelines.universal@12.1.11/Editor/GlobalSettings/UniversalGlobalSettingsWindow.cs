        ...
        static void DrawLightLayerNames(SerializedUniversalRenderPipelineGlobalSettings serialized, Editor owner)
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                using (var changed = new EditorGUI.ChangeCheckScope())
                {
                    ...
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName8, Styles.renderingLayerName8);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName9, Styles.renderingLayerName9);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName10, Styles.renderingLayerName10);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName11, Styles.renderingLayerName11);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName12, Styles.renderingLayerName12);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName13, Styles.renderingLayerName13);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName14, Styles.renderingLayerName14);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName15, Styles.renderingLayerName15);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName16, Styles.renderingLayerName16);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName17, Styles.renderingLayerName17);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName18, Styles.renderingLayerName18);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName19, Styles.renderingLayerName19);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName20, Styles.renderingLayerName20);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName21, Styles.renderingLayerName21);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName22, Styles.renderingLayerName22);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName23, Styles.renderingLayerName23);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName24, Styles.renderingLayerName24);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName25, Styles.renderingLayerName25);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName26, Styles.renderingLayerName26);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName27, Styles.renderingLayerName27);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName28, Styles.renderingLayerName28);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName29, Styles.renderingLayerName29);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName30, Styles.renderingLayerName30);
                    EditorGUILayout.DelayedTextField(serialized.renderingLayerName31, Styles.renderingLayerName31);
                    if (changed.changed)
                    {
