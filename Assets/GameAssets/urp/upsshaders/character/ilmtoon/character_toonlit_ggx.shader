Shader "urpshaders/character/character_toonlit_ggx"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(ToonVaryings input) : SV_Target
            {
                ...
                // half layer = SAMPLE_TEXTURE2D(_DebugTex, sampler_DebugTex, input.uv.xy).r * 255;
                //
                // if(layer < 60)
                // {
                ...
                // else if(layer < 160)
                // {
                //     finalColor = half4(0,1,0,1);
                // }
                // else
                // {
                //     finalColor = half4(0,0,1,1);
                // }
                // return finalColor;
