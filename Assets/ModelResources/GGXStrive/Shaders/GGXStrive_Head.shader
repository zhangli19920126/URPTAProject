Shader "NPR/GGXStrive_Head"
{
    Properties
    {
        ...
        _LightThreshold("头发 _LightThreshold",Range(-2,2))=1
        _RampOffset("RampOffset",Range(-2,2)) =0
        _DarkIntensity("暗部强度",Range(0,1)) = 0
        
        _LightThresholdFace("脸部_LightThresholdFace",Range(-2,2))=1
        ...
        [KeywordEnum(None,Base,Base_A,Shadow,Shadow_A,Line,Mix,LM_R,LM_G,LM_B,LM_A,UV,UV2,VC,VC_R,VC_G,VC_B,VC_A,T,N)] _TestMode("_TestMode",Int) = 0
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D _BaseMap,_LightMap,_LineMap,_MixMap,_ShadowMap;
            ...
            float _LightThreshold,_RampOffset,_LightThresholdFace;
            ...
            // #pragma multi_compile FACESHADOWMODE_TEX FACESHADOWMODE_COLOR
...
/*==========================Diffuse ==========================*/
                //脸部
                // return ShadowMap*BaseMap;

                // return  ShadowMap*BaseMap;
                // return BaseMap*_FaceShadowColor;
                if (VertexColor.g<0.9)
                {
                    NL = dot(T.xz,L.xz);
                    // NL = dot(T,L);
                    float NL01 = 0.5*NL+0.5;
                    float Threshold = step(_LightThresholdFace,(NL01 + _RampOffset +0 )*ShadowAOMask);
                    ...
                    return Diffuse.xyzz*_LumIntensity;
                }
    ...
    /*==========================边缘光 ==========================*/
        ...
        Pass
        {
            ...
            VertexToFragmentData vert(appdata v)
            {
                VertexToFragmentData o;
